...
export function WorkspacePanel({
  ...
  return (
    <div
      className={`flex flex-col min-h-[300px] rounded-xl border border-white/[0.07] bg-[oklch(0.085_0.005_240)] overflow-hidden transition-shadow duration-200 ${borderClass}`}
      onClick={onFocus}
      role="region"
