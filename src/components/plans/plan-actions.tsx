...
import { CheckCircle, Play, Loader2, Bot, MessageSquare, ListTodo } from 'lucide-react';
...
export function PlanActions({
  ...
  return (
    <>
      ...
      {/* Break into tasks dialog */}
      <Dialog
        open={breakdownOpen}
        onOpenChange={(v) => {
          if (!isBreakingDown) setBreakdownOpen(v);
        }}
      >
        <DialogContent className="max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription>
              An agent will decompose this plan into individual tasks on the board. It will NOT
              implement anything — you can review, reorder, and edit the tasks before execution.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            <Button variant="outline" size="sm" onClick={() => setBreakdownOpen(false)}>
              Cancel
            </Button>
            <Button
              size="sm"
